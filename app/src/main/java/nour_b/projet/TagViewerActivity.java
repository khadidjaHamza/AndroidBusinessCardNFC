...
import nour_b.projet.utils.NdefMessageParser;
...
public class TagViewerActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toCard = (Button) findViewById(R.id.buttonToCard);
    ...
    private String dumpTagData(Tag tag) {
        ...
        byte[] id = tag.getId();
        sb.append("Nom : ").append(card.getName()).append('\n');
        sb.append("Prénom: ").append(card.getSurname()).append('\n');
        sb.append("Email: ").append(card.getMail()).append('\n');
        sb.append("Adresse: ").append(card.getAddress()).append('\n');
        sb.append("Téléphone 1 : ").append(card.getTel1()).append('\n');
        sb.append("Téléphone 2 : ").append(card.getTel2()).append('\n');
        sb.append("Site web: ").append(card.getWebsite()).append('\n');
        ...
        toCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TagViewerActivity.this, PersonalCardActivity.class);
                System.out.println("dans le tag ");
                intent.putExtra("Card", (Serializable) card);
                intent.putExtra("eMAIL", card.getMail());
